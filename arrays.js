...
// The shift method will remove the last "false" from the booleans array and return the length of the remaining elements in the array.;
...
console.log (booleans [1]);     // This will print "false";
